...
![](./image/base/tomcat7.png)
 
#### 设置为开机启动
右击服务，选择属性，把服务启动类型改为自动；

![](./image/base/tomcat8.png)

#### 通过tomcat服务配置工具启动

进入tomcat\bin目录,以管理员权限运行tomcat7w.exe

![](./image/base/tomcat9.png)
